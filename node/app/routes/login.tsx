              ...
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  {error && (
                      <div>
                        ...
                        <p class="text-sm font-medium text-red-500 dark:text-red-400">
                          Psss use <strong>{DUMMY_USER}</strong> as username and <strong>{DUMMY_PASSWORD}</strong> as password
                        </p>
                      </div>
                  )}
                  <form class="space-y-4 md:space-y-6" method="POST">
                      <div>
                          ...
                          <input type="text" name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={DUMMY_USER} required />
                      </div>
                      <div>
                      ...
                      <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Use <strong>{DUMMY_USER}</strong> as username and <strong>{DUMMY_PASSWORD}</strong> as password
                      </p>
                  </form>
              </div>
          </div>
