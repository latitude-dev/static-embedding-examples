...
export const POST = createRoute(async (c) => {
  ...
  return c.redirect(RedirectPath.home)
})
...
export default createRoute((c) => {
  ...
  if (redirect && redirect !== RedirectPath.login) {
          ...
          <div class='p-6 space-y-4 md:space-y-6 sm:p-8'>
            ...
            <form class='space-y-4 md:space-y-6' method='POST'>
              ...
              <p class='text-lg font-light text-gray-600 dark:text-gray-400'>
                Easy, use <strong class='text-blue-500'>{DUMMY_USER}</strong> as username and{' '}
                <strong class='text-blue-500'>{DUMMY_PASSWORD}</strong> as password
              </p>
            </form>
          </div>
        </div>
